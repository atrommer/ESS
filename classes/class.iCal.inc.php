...
//| Updated: Andrew Trommer <atrommer.gmail.com> 20050412                |
//+----------------------------------------------------------------------+
//
// $Id: class.iCal.inc.php,v 1.1 2005/04/19 00:33:39 atrommer Exp $
...
class iCal {
	...
	*/
	...
	// promoted to class level method from generateOutput
	// atrommer - 20050412
	...
	* @since 1.001 - 2002-10-10
	*/
	// removed isEmpty from local method and promoted to class
	// php5 didn't like previous behavior
	// updated all local calls to isEmpty to call class level method
	// atrommer - 20050412
	private function generateOutput($format = 'ics') {
		...
		if ($this->output_format == 'ics') {
			...
			foreach ($eventkeys as $id) {
				...
				// added isEmpty checking for correct parsing
				// atrommer - 20050412
				if (!$this->isEmpty($event->getAlarm())){
